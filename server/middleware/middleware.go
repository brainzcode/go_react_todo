...
import (
	...
	"github.com/brainzcode/go_react_todo/models"
...
func deleteAllTasks() int64 {
	delM, err := collection.DeleteMany(context.Background(), bson.D(nil))
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println("Deleted Document:", delM.DeletedCount)
	return delM.DeletedCount
}
